    ...
    <div style="background:#0a0b0f;padding:40px 20px;font-family:'Inter',system-ui,sans-serif;">
      <div style="max-width:520px;margin:0 auto;background:#13141a;border:1px solid rgba(255,255,255,0.08);border-radius:16px;padding:40px;color:#9ca3af;">
        ...
        <table style="width:100%;border-collapse:collapse;margin-bottom:24px;">
          <tr><td style="padding:6px 0;color:#888;width:80px;">Name</td><td style="padding:6px 0;color:#f3f4f6;">{body.name}</td></tr>
          <tr><td style="padding:6px 0;color:#888;">Email</td><td style="padding:6px 0;color:#a5b4fc;"><a href="mailto:{body.email}" style="color:#a5b4fc;">{body.email}</a></td></tr>
        </table>
        <div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);border-radius:10px;padding:16px;">
          <p style="margin:0;white-space:pre-wrap;color:#d1d5db;font-size:14px;line-height:1.6;">{body.message}</p>
        </div>
      </div>
    </div>
    """
    send_email(OWNER_EMAIL, f"Contact: {body.name} — claudefo.com", html)
